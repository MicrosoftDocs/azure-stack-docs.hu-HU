...
5. Adja meg az **engedélyezési visszahívási URL-címet**. Egy alapértelmezett Azure Stack hub-telepítésben az URL-cím az űrlapon található `https://portal.<region>.<FQDN>/TokenAuthorize` . 
...
4. Adja meg az alkalmazás **leírását** .
5. Adja meg a **visszahívási URL-címet**. Az Azure Stack hub alapértelmezett telepítése során a visszahívási URL-cím az űrlapon található `https://portal.<region>.<FQDN>/TokenAuthorize` . Ahhoz, hogy a BitBucket-integráció sikeres legyen, az URL-címnek követnie kell az itt felsorolt nagybetűket.
...
7. Adja meg az **átirányítási URI**-t. Az Azure Stack hub alapértelmezett központi telepítése során az átirányítási URI az űrlapon található `https://portal.<region>.<FQDN>/TokenAuthorize` .
...
8. Állítsa be a **OAuth 2 átirányítási URI** -t, majd válassza a **Hozzáadás**lehetőséget. Az Azure Stack hub alapértelmezett központi telepítése során az átirányítási URI az űrlapon található `https://portal.<region>.<FQDN>/TokenAuthorize` .
