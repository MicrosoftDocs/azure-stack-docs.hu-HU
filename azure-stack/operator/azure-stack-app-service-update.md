...
1. Töltse le a [Azure app Service telepítőjét](https://aka.ms/appsvcupdateQ3installer).
...
> [!IMPORTANT]
> A frissítés futtatása előtt el kell végeznie [Azure app Service telepítését a Azure stack hub-ban egy leválasztott környezetben](./azure-stack-app-service-deploy.md?pivots=state-disconnected). 
