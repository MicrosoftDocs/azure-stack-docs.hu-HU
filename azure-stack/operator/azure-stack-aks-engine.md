---
title: Kubernetes Services-motor előfeltételeinek hozzáadása a Azure Stack hub Marketplace-hez
description: Megtudhatja, hogyan adhatja hozzá az Azure Kubernetes Services (ak) motorjának előfeltételeit Azure Stack hub Marketplace-hez.
author: mattbriggs
ms.topic: article
ms.date: 2/27/2020
ms.author: mabrigg
...
Az AK alaprendszerképét hozzáadhatja Azure Stack hub Marketplace-hez az elem Azure-ból való beolvasásával. Ha azonban az Azure Stack hub le van választva, tekintse meg a [Marketplace-elemek letöltése az Azure-ból](https://docs.microsoft.com/azure-stack/operator/azure-stack-download-azure-marketplace-item?view=azs-1908#disconnected-or-a-partially-connected-scenario) című témakört az elem hozzáadására vonatkozó utasításokért. Adja hozzá az 5. lépésben megadott elemeket.
...
1. Válassza ki a parancsfájlt a következő profillal:
   ...
   - **Közzétevő**: Microsoft Corp
     ...
     > [!Note]  
     > A Linux rendszerhez készült egyéni szkript több verziója is szerepelhet a felsorolásban. Hozzá kell adnia az elem utolsó verzióját.
