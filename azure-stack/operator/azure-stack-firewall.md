...
Jelenleg ajánlott letiltani az SSL-elfogást (például a visszafejtés kiszervezését) az összes Azure Stack-forgalomon. Ha a jövőbeli frissítések támogatják, útmutatást nyújt a Azure Stack SSL-elfogásának engedélyezéséhez.
