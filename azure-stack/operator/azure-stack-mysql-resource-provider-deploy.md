...
- Adja hozzá a szükséges Windows Server-alapú virtuális gépet Azure Stack hub Marketplace-hez.
  ...
  - A MySQL RP >= 1.1.93.0 esetében töltse le a **Microsoft AzureStack Add-On RP Windows Server** -rendszerképet. Ez a Windows Server-verzió a Azure Stack Add-On RP-infrastruktúrára specializálódott, és nem látható a bérlői piactéren.
