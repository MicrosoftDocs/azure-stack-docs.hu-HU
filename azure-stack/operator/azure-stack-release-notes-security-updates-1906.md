---
title: Az Azure Stack – kibocsátási megjegyzések – biztonsági frissítések, 1906 |} A Microsoft Docs
description: Ismerje meg a 1906 biztonsági frissítéseket az Azure Stackhez.
...
ms.locfileid: "67419834"
---
# <a name="azure-stack-security-updates"></a>Az Azure Stack biztonsági frissítések

Ez a cikk felsorolja az utolsó négy frissítéseket az Azure Stack a biztonsági frissítéseket. Ezeket az információkat csak tájékoztatási céllal van megadva.

## <a name="1906-update"></a>1906 update

Ez a frissítés az Azure Stack nem tartalmazza az alapul szolgáló operációs rendszer, amely az Azure Stack biztonsági frissítéseket.

## <a name="1905-update"></a>1905 update

A 1905 frissítés telepítésekor a következő biztonsági frissítések:
...
Windows-frissítések összesített jellege miatt a frissítésben is az előző hónapra biztonsági is észleltünk adattartalmakat. A fenti CVEs listáját jeleníti meg a biztonsági hasznos március, április és május 2019.
További információ a biztonsági rések, kattintson a fenti hivatkozásokat a, vagy tekintse meg a Microsoft Tudásbázis cikkei [4499177](https://support.microsoft.com/en-us/help/4499177).

## <a name="1904-update"></a>1904 update

Ez a frissítés az Azure Stack nem tartalmazza az alapul szolgáló operációs rendszer, amely az Azure Stack biztonsági frissítéseket.

## <a name="1903-update"></a>1903 update

Ez a frissítés az Azure Stack nem tartalmazza az alapul szolgáló operációs rendszer, amely az Azure Stack biztonsági frissítéseket.  

## <a name="1902-update"></a>1902 update

A 1902 frissítés telepítésekor a következő biztonsági frissítések:  
