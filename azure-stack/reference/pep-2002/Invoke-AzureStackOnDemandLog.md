---
title: Azure Stack hub AzureStackOnDemandLog végpontjának meghívása
description: Hivatkozás a PowerShell Azure Stack privilegizált végpont-meghívás-AzureStackOnDemandLog
author: mattbriggs
ms.topic: reference
ms.date: 04/27/2020
ms.author: mabrigg
...
Igény szerinti naplókat hoz létre Azure Stack hub-szerepkörökből, ahol lehetséges.
