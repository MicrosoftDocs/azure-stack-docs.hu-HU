...
Ha a set-AzureRmKeyvaultAccessPolicy-t egy ADFS-ben konfigurált Azure Stack hub-környezettel használja, meg kell adni a BypassObjectIdValidation paramétert.
