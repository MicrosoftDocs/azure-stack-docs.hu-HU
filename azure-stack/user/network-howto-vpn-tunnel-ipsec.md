---
title: VPN-alagút létrehozása az IPSEC használatával a Azure Stackban | Microsoft Docs
description: Megtudhatja, hogyan hozhat létre VPN-alagutat a Azure Stack IPSEC szolgáltatásával.
...
ms.locfileid: "73167563"
---
# <a name="how-to-create-a-vpn-tunnel-using-ipsec--in-azure-stack"></a>VPN-alagút létrehozása az IPSEC használatával Azure Stack
...
Ez a megoldás olyan alap, amely lehetővé teszi, hogy a VPN-alagutak ne csak Azure Stack példányon belül jöjjenek létre, hanem Azure Stack példányok és más erőforrások, például a Windows RRAS S2S VPN-alagutak használatát használó helyszíni hálózatok számára is.
