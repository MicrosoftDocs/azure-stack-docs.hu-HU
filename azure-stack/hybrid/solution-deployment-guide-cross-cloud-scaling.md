...
> [!Note]  
> Azure Stack központ futtatásához (Windows Server és SQL) és a App Service üzembe helyezéshez szükséges megfelelő rendszerképekkel. További információkért tekintse át a [app Service üzembe helyezéséhez szükséges](../operator/azure-stack-app-service-before-you-get-started.md)app Service dokumentációt az Azure stack hub-on.
